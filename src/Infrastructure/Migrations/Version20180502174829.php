 ...
 */
class Version20180502174829 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, apellidos, nickname, fecha_nacimiento, email, password, name FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, apellidos VARCHAR(40) NOT NULL COLLATE BINARY, nickname VARCHAR(20) NOT NULL COLLATE BINARY, fecha_nacimiento DATE NOT NULL, email VARCHAR(100) NOT NULL COLLATE BINARY, password VARCHAR(60) NOT NULL COLLATE BINARY, name VARCHAR(25) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO user (id, apellidos, nickname, fecha_nacimiento, email, password, name) SELECT id, apellidos, nickname, fecha_nacimiento, email, password, name FROM __temp__user');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, apellidos VARCHAR(40) NOT NULL, nickname VARCHAR(20) NOT NULL, password VARCHAR(60) NOT NULL, fecha_nacimiento DATE NOT NULL, email VARCHAR(100) NOT NULL, name VARCHAR(30) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
