 ...
 */
class Version20180505083603 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, nickname VARCHAR(20) NOT NULL COLLATE BINARY, email VARCHAR(100) NOT NULL COLLATE BINARY, password VARCHAR(60) NOT NULL COLLATE BINARY, name VARCHAR(25) NOT NULL COLLATE BINARY, surname VARCHAR(40) NOT NULL, birth_date DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO user (id, surname, nickname, birth_date, email, password, name) SELECT id, apellidos, nickname, fecha_nacimiento, email, password, name FROM __temp__user');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D649A188FE64');
        $this->addSql('DROP INDEX UNIQ_8D93D649E7927C74');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, name, surname, nickname, password, birth_date, email FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, name VARCHAR(25) NOT NULL, nickname VARCHAR(20) NOT NULL, password VARCHAR(60) NOT NULL, email VARCHAR(100) NOT NULL, apellidos VARCHAR(40) NOT NULL COLLATE BINARY, fecha_nacimiento DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO user (id, name, apellidos, nickname, password, fecha_nacimiento, email) SELECT id, name, surname, nickname, password, birth_date, email FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649A188FE64 ON user (nickname)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
        $this->addSql('DROP INDEX IDX_A7DD90B1F270FD45');
