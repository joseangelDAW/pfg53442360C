 ...
 */
class Version20180530074901 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE entry_entity (id INTEGER NOT NULL, title VARCHAR(100) NOT NULL, image VARCHAR(100) NOT NULL, content CLOB NOT NULL, PRIMARY KEY(id))');
