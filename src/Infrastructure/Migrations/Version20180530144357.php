 ...
 */
class Version20180530144357 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, name VARCHAR(25) NOT NULL COLLATE BINARY, surname VARCHAR(40) NOT NULL COLLATE BINARY, nickname VARCHAR(20) NOT NULL COLLATE BINARY, password VARCHAR(60) NOT NULL COLLATE BINARY, birth_date DATE NOT NULL, email VARCHAR(60) NOT NULL, role VARCHAR(10) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO user (id, name, surname, nickname, password, birth_date, email) SELECT id, name, surname, nickname, password, birth_date, email FROM __temp__user');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, name, surname, nickname, password, birth_date, email FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, name VARCHAR(25) NOT NULL, surname VARCHAR(40) NOT NULL, nickname VARCHAR(20) NOT NULL, password VARCHAR(60) NOT NULL, birth_date DATE NOT NULL, email VARCHAR(100) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO user (id, name, surname, nickname, password, birth_date, email) SELECT id, name, surname, nickname, password, birth_date, email FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649A188FE64 ON user (nickname)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
