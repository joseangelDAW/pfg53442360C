 ...
 */
class Version20180502174803 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, name, apellidos, nickname, fecha_nacimiento, email, password FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, apellidos VARCHAR(40) NOT NULL COLLATE BINARY, nickname VARCHAR(20) NOT NULL COLLATE BINARY, fecha_nacimiento DATE NOT NULL, email VARCHAR(100) NOT NULL COLLATE BINARY, password VARCHAR(60) NOT NULL COLLATE BINARY, name VARCHAR(30) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO user (id, name, apellidos, nickname, fecha_nacimiento, email, password) SELECT id, name, apellidos, nickname, fecha_nacimiento, email, password FROM __temp__user');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D649A188FE64');
        $this->addSql('DROP INDEX UNIQ_8D93D649E7927C74');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, name, apellidos, nickname, password, fecha_nacimiento, email FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, apellidos VARCHAR(40) NOT NULL, nickname VARCHAR(20) NOT NULL, password VARCHAR(60) NOT NULL, fecha_nacimiento DATE NOT NULL, email VARCHAR(100) NOT NULL, name VARCHAR(25) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO user (id, name, apellidos, nickname, password, fecha_nacimiento, email) SELECT id, name, apellidos, nickname, password, fecha_nacimiento, email FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649A188FE64 ON user (nickname)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
        $this->addSql('DROP INDEX IDX_7289F433866C74FC');
